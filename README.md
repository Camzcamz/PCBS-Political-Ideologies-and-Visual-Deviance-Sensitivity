...
I had a negligable amount of knowledge of python prior to this class (e.g. I knew what loops were but could not program them) and had run (not coded) Matlab for my experiments during my bachelors and then Eprime for my M1. Python was introduced to me during the first week of september at the cogmaster in 2017. I think that it would have been helpful to attend the python classes this year in september because I had forgotten the little we had previously learned even if I tried to review some concepts with Code Academy and lack knowledge some of my classmates gained in this years class (e.g. What is Spyder). The september python review classes in M2 should be strongly recommended to students that already took them in M1 but couldn't take AE in M1 due to space limitations.

I started working on the project very early on in the semester because I find it easier to learn new programs (python and expyriment) with a bigger goal than small exercises. I think the small exercices were helpful to get started but that after a few I felt as though I would learn most about how to program an experiment (with conditions, blocks, different stimuli..) by startingt the final project. I think that my biggest difficulty was learning to use expyriment because I didn't find their documentation very helpful for novices. This is why I asked so many questions on slack! I don't really know why people didn't use it but I think that teachers and students are simultaneously discovering these platforms, which takes a bit of time to start using and see its advantage. 
